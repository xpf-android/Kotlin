...
public class HiBanner extends FrameLayout implements IHiBanner {
    ...
    @Override
    public void setHaIndicator(HiIndicator hiIndicator) {
        delegate.setHaIndicator(hiIndicator);
    }
    ...
    private void initCustomAttrs(Context context, AttributeSet attrs) {
        ...
        boolean loop = typedArray.getBoolean(R.styleable.HiBanner_autoPlay, true);
